...
"Abgabe-Manager" finde ich passend, da wir die Funktion von Auas zum teil übernehmen und die Zuweisungen der Abgaben an die jeweilige Korrektoren verteilen und verwalten. Dadurch haben wir ein geordnetes Verwaltungssystem.
